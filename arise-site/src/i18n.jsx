...
const translations = {
  en: {
    ...
    volunteer: {
      ...
      roles: { Registration: "Registration", Ushers: "Ushers", Parking: "Parking", Security: "Security", Hospitality: "Hospitality", "Prayer and Counselling": "Prayer and Counselling", Production: "Production", Media: "Media", Stage: "Stage", Medical: "Medical", Logistics: "Logistics",},
  ...
  hi: {
    ...
    volunteer: {
      ...
      roles: { Registration: "पंजीकरण", Ushers: "स्वागत", Parking: "पार्किंग", Security: "सुरक्षा", Hospitality: "आतिथ्य", "Prayer and Counselling": "प्रार्थना और परामर्श", Production: "प्रोडक्शन", Media: "मीडिया", Stage: "मंच", Medical: "चिकित्सा", Logistics: "लॉजिस्टिक्स",},
